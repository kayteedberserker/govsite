...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-400 pt-24 pb-12 border-t border-emerald-900/20 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-96 h-96 bg-emerald-500/5 rounded-full blur-[120px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12 pb-16 border-b border-slate-900">
          <div className="max-w-xl">
            <Link href="/" className="flex items-center gap-4 mb-8 group">
              <div className="w-14 h-14 bg-emerald-700 text-white flex items-center justify-center rounded-2xl font-bold text-2xl shadow-lg shadow-emerald-900/20 group-hover:rotate-6 transition-transform duration-300">
                BAF
              </div>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-slate-100 leading-tight mb-6">
              ...
              built on <span className="text-emerald-500">transparency</span> and action.
            </h2>
          </div>
          ...
          <div className="flex gap-3">
            {['Twitter', 'Facebook', 'Instagram'].map((platform) => (
              <a 
                key={platform}
                href="#" 
                className="w-12 h-12 flex items-center justify-center rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:bg-emerald-700 hover:text-white hover:-translate-y-1 transition-all duration-300 shadow-xl"
                aria-label={platform}
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-12 gap-x-8 py-16">
          ...
          <div className="col-span-1">
            <h3 className="text-emerald-500 font-bold text-xs tracking-[0.2em] uppercase mb-8">Connect</h3>
            <ul className="space-y-4">
              <li><Link href="/contact" className="hover:text-white transition-colors text-sm font-semibold text-emerald-500 underline decoration-emerald-500/30 underline-offset-4">Volunteer Today</Link></li>
              <li><a href="updates" className="hover:text-white transition-colors text-sm font-semibold">Campaign Updates</a></li>
              <li><a href="media" className="hover:text-white transition-colors text-sm font-semibold">Media Inquiries</a></li>
            </ul>
          </div>

          {/* Column 3: Location (Spans 2 columns on mobile) */}
          <div className="col-span-2">
            <h3 className="text-emerald-500 font-bold text-xs tracking-[0.2em] uppercase mb-8">Headquarters</h3>
        ...
        <div className="pt-12 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button 
            ...
            className="group flex items-center gap-3 text-xs font-black uppercase tracking-widest text-emerald-500 hover:text-white transition-colors"
          >
            Back to Top
            <div className="w-8 h-8 rounded-full border border-emerald-500/30 flex items-center justify-center group-hover:bg-emerald-500 group-hover:text-white transition-all">
