  ...
  if (!article) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center pt-24 text-center px-4">
        ...
        <Link href="/updates" className="text-[#4b66c1] font-bold uppercase tracking-widest hover:underline">Return to Newsroom</Link>
      </div>
    );
  }
    ...
    <article className="bg-white min-h-screen pb-24">
        ...
        <div className="absolute bottom-0 left-0 w-full px-4 sm:px-6 lg:px-8 translate-y-1/2">
          <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-[2rem] shadow-2xl border border-slate-100">
            <div className="flex flex-wrap items-center gap-4 mb-6">
              <span className="bg-[#4b66c1]/10 text-[#243465] border border-[#4b66c1]/20 px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-widest">
                {article.category}
              </span>
            ...
            <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
              <div className="w-12 h-12 bg-[#243465] rounded-full flex items-center justify-center text-white font-bold tracking-tighter">
                BAF
              </div>
              <div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 mt-48 md:mt-56">
        <div className="prose prose-lg prose-slate max-w-none">
          <p className="text-xl md:text-2xl text-slate-500 leading-relaxed font-medium italic mb-10 border-l-4 border-[#4b66c1] pl-6">
            {article.excerpt}
          </p>
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-6">
          <Link href="/updates" className="text-[#4b66c1] font-bold uppercase tracking-widest text-sm hover:text-slate-900 transition-colors flex items-center gap-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="w-10 h-10 rounded-full bg-slate-100 text-slate-600 hover:bg-[#4b66c1] hover:text-white transition-colors flex items-center justify-center font-bold text-xs uppercase">X</button>
            <button className="w-10 h-10 rounded-full bg-slate-100 text-slate-600 hover:bg-[#4b66c1] hover:text-white transition-colors flex items-center justify-center font-bold text-xs uppercase">FB</button>
            <button className="w-10 h-10 rounded-full bg-slate-100 text-slate-600 hover:bg-[#4b66c1] hover:text-white transition-colors flex items-center justify-center font-bold text-xs uppercase">IN</button>
          </div>
        </div>
      </div>
