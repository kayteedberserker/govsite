    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <section className="bg-slate-950 pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-30 pointer-events-none">
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-emerald-600 rounded-full blur-[120px]"></div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-800 pb-10">
            <div>
              ...
              <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase italic leading-none">
                Campaign <span className="text-emerald-500">Updates</span>
              </h1>
            </div>
                ...
                <div className="bg-white rounded-3xl overflow-hidden shadow-[0_20px_60px_rgb(0,0,0,0.08)] border border-slate-100 flex flex-col lg:flex-row transition-transform duration-300 group-hover:-translate-y-1">
                  ...
                  <div className="lg:w-2/5 p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                    <div className="flex items-center gap-4 mb-6">
                      <span className="bg-emerald-50 text-emerald-700 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest">
                    ...
                    <h2 className="text-3xl md:text-4xl font-black text-slate-900 tracking-tight leading-tight mb-6 group-hover:text-emerald-700 transition-colors">
                      {featuredPost.title}
                    </h2>
                ...
                {standardPosts.map((post) => (
                  <Link key={post._id} href={`/updates/${post._id}`} className="group flex flex-col h-full bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-[0_20px_40px_rgb(0,0,0,0.06)] border border-slate-100 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div className="relative aspect-[16/9] overflow-hidden bg-slate-100">
                      ...
                      />
                      <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest text-slate-900 shadow-sm">
                        {post.category}
                      </div>
                    </div>
                    ...
                    <div className="p-6 md:p-8 flex flex-col flex-1">
                      ...
                      <h4 className="text-xl font-black text-slate-900 leading-snug mb-3 group-hover:text-emerald-700 transition-colors line-clamp-2">
                        {post.title}
                      </h4>
                      ...
                      <div className="mt-auto flex items-center text-emerald-600 font-bold uppercase tracking-widest text-xs">
                        Read More
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 mt-12">
        <div className="bg-slate-900 rounded-[2rem] p-10 md:p-16 relative overflow-hidden text-center shadow-2xl">
          ...
          <div className="relative z-10">
            <svg className="w-12 h-12 text-emerald-500 mx-auto mb-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <form className="flex flex-col sm:flex-row max-w-lg mx-auto gap-3">
              <input 
                ...
                className="flex-1 bg-slate-800/50 border border-slate-700 text-white px-6 py-4 rounded-xl focus:outline-none focus:border-emerald-500 focus:bg-slate-800 transition-colors"
                required
              />
              <button 
                type="submit" 
                className="bg-emerald-600 text-white font-black uppercase tracking-widest px-8 py-4 rounded-xl shadow-lg shadow-emerald-600/20 hover:bg-emerald-500 active:scale-95 transition-all"
              >
                Subscribe
              </button>
            </form>
