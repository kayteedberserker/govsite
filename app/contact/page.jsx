...
export default function ContactPage() {
  ...
  const socialLinks = [
    ...
    {
      platform: 'Instagram',
      href: 'https://www.instagram.com/official_buharioyonorth/',
      icon: (
  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-slate-950 pt-32 pb-48 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#4b66c1]/15 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3"></div>

        <div className="max-w-7xl mx-auto text-center relative z-10">
          <span className="inline-block py-1.5 px-4 rounded-full bg-[#4b66c1]/10 border border-[#4b66c1]/20 text-[#4b66c1] font-bold tracking-[0.2em] text-xs uppercase mb-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter uppercase italic leading-tight mb-6">
            Join The <span className="text-[#4b66c1]">Movement</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_20px_60px_rgb(0,0,0,0.08)] border border-slate-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              {status.success && (
                <div className="bg-[#bcc8eb]/30 border border-[#4b66c1]/30 text-[#243465] px-6 py-4 rounded-2xl font-bold text-sm tracking-wide">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="relative group">
                  <label className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1 block transition-colors group-focus-within:text-[#4b66c1]">Email Address</label>
                  <input
                    type="email"
                    name="email"
              ...
              <div className="relative group">
                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1 block transition-colors group-focus-within:text-[#4b66c1]">Subject / Category</label>
                <select
                  name="subject"
                  value={formData.subject}
                  onChange={handleChange}
                  required
                  className="w-full bg-transparent border-b-2 border-slate-200 py-2 text-slate-900 font-medium focus:outline-none focus:ring-0 focus:border-[#4b66c1] transition-colors rounded-none px-0 appearance-none cursor-pointer"
                >
              ...
              <div className="relative group">
                <label className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1 block transition-colors group-focus-within:text-[#4b66c1]">Your Message</label>
                <textarea
                  name="message"
                  ...
                  required
                  rows="4"
                  className="w-full bg-transparent border-b-2 border-slate-200 py-2 text-slate-900 font-medium focus:outline-none focus:ring-0 focus:border-[#4b66c1] transition-colors rounded-none px-0 resize-none"
              ...
              <div className="pt-4">
                {status.loading ? (
                  <div className="flex justify-center items-center py-4 bg-slate-50 rounded-2xl border border-slate-200">
                    ...
                    <span className="ml-3 text-[#243465] font-bold text-sm uppercase tracking-widest">Transmitting...</span>
                  </div>
                ) : (
                  <button
                    type="submit"
                    className="w-full bg-[#243465] text-white font-black tracking-widest uppercase py-4 px-6 rounded-2xl shadow-[0_8px_20px_rgba(36,52,101,0.3)] hover:bg-slate-900 hover:shadow-[0_8px_20px_rgba(15,23,42,0.3)] hover:-translate-y-1 transition-all duration-300 active:scale-[0.98]"
                  >
                    Submit Mandate
                  </button>
                )}
