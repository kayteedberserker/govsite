  ...
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="bg-slate-950 pt-16 pb-24 px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center border-b border-slate-900">
        <div className="inline-block py-1.5 px-5 rounded-full bg-[#4b66c1]/10 border border-[#4b66c1]/20 text-[#4b66c1] font-bold tracking-[0.2em] text-xs uppercase mb-8 shadow-[0_0_20px_rgba(75,102,193,0.15)]">
          Official Campaign Hub
        </div>

        <h2 className="text-2xl md:text-3xl font-bold text-slate-400 tracking-widest uppercase mb-4">
          Buhari AbdulFatai <span className="text-[#4b66c1]">2027</span>
        </h2>
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-white tracking-tighter uppercase italic leading-[0.95] mb-8">
          ...
          <span className="text-[#4b66c1]">Real Results.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link href="/about" className="bg-[#243465] text-white px-10 py-4 rounded-full font-black tracking-widest uppercase text-sm hover:bg-[#172242] transition-all shadow-[0_0_40px_rgba(36,52,101,0.4)] active:scale-95 flex items-center justify-center gap-2">
            Meet The Candidate
          </Link>
      ...
      {/* ================= 2. INFINITE TICKER ================= */}
      <div className="bg-[#243465] py-4 overflow-hidden shadow-inner border-y border-[#172242]">
        <div className="whitespace-nowrap flex animate-[marquee-left_30s_linear_infinite]">
          {[...Array(4)].map((_, i) => (
            <span key={i} className="text-[#bcc8eb] font-black uppercase tracking-[0.3em] text-sm mx-8 flex items-center">
              Economic Revival <span className="mx-8 text-[#4b66c1]">•</span>
              21st Century Education <span className="mx-8 text-[#4b66c1]">•</span>
              Total Security <span className="mx-8 text-[#4b66c1]">•</span>
              Modern Infrastructure <span className="mx-8 text-[#4b66c1]">•</span>
            </span>
          ))}
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="absolute -inset-4 bg-[#bcc8eb]/20 rounded-[3rem] transform -rotate-3 z-0"></div>
            ...
            <div className="relative z-10">
              <span className="text-[#4b66c1] font-bold tracking-[0.2em] uppercase text-sm mb-4 block">The Candidate</span>
              ...
              <Link href="/about" className="inline-flex items-center gap-3 text-[#243465] font-black uppercase tracking-widest text-sm hover:text-[#4b66c1] transition-colors group">
                Read Full Biography
                <span className="w-10 h-10 rounded-full bg-[#bcc8eb]/30 group-hover:bg-slate-100 flex items-center justify-center transition-colors">
      ...
      <section className="py-24 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-[#4b66c1] font-bold tracking-[0.2em] uppercase text-sm mb-4 block">The Agenda</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 bg-[#4b66c1]/10 rounded-2xl flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-[#4b66c1]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
              </div>
            ...
            <div className="bg-slate-900 p-8 rounded-3xl shadow-xl border border-slate-800 hover:-translate-y-2 transition-all duration-300 transform md:-translate-y-4">
              <div className="w-12 h-12 bg-[#4b66c1]/20 rounded-2xl flex items-center justify-center mb-6">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 bg-[#4b66c1]/10 rounded-2xl flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-[#4b66c1]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 14l9-5-9-5-9 5 9 5z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 21l9-5-9-5-9 5 9 5z" /></svg>
              </div>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
              <div className="w-12 h-12 bg-[#4b66c1]/10 rounded-2xl flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-[#4b66c1]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
              </div>
          ...
          <div className="mt-12">
            <Link href="/about" className="inline-flex items-center text-[#243465] font-black uppercase tracking-widest text-sm hover:text-[#4b66c1] transition-colors">
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              <span className="text-[#4b66c1] font-bold tracking-[0.2em] uppercase text-sm mb-2 block">Campaign Trail</span>
          ...
          {latestNews.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {latestNews.map((article) => (
                <Link key={article._id} href={`/updates/${article._id}`} className="group flex flex-col h-full bg-slate-50 rounded-2xl overflow-hidden border border-slate-100 hover:border-[#4b66c1]/40 hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-8 flex flex-col flex-1">
                    ...
                    <h4 className="text-xl font-black text-slate-900 leading-snug mb-3 group-hover:text-[#4b66c1] transition-colors line-clamp-2">{article.title}</h4>
                    <p className="text-slate-500 text-sm leading-relaxed mb-6 line-clamp-3 flex-1">{article.excerpt}</p>
                    <div className="mt-auto text-[#4b66c1] font-bold uppercase tracking-widest text-xs flex items-center">
      ...
      <section className="bg-slate-900 py-16 border-y border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
          ...
          <Link href="/media" className="shrink-0 bg-white hover:bg-slate-200 text-[#243465] px-8 py-4 rounded-xl font-black uppercase tracking-widest text-sm transition-colors shadow-lg active:scale-95">
            Access Press Kit
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-950 text-white relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div>
              <span className="text-[#4b66c1] font-bold tracking-[0.2em] uppercase text-sm mb-2 block">Campaign Gallery</span>
      ...
      {/* ================= 8. FINAL CTA ================= */}
      <section className="py-32 bg-[#243465] text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <span className="text-[#bcc8eb] font-bold tracking-[0.3em] uppercase text-sm mb-4 block">Take Action</span>
